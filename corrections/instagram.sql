...
-- works fine if the user for a photo is not null.If there is null,it won't show in the result
-- Left/right outer join solves this problem
...
comments.user_id = photos.user_id;
HAVING
-- Find the number of comments for each photo where the photo_id is less that 3 and the photo has more than 2 comments
SELECT
photo_id,
