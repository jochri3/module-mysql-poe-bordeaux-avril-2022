...
-- 2.Pour chaque commentaire, afficher son cotenu et l'url de la photo à laquel le commentaire a été ajouté
...
-- fonctionne bien si l'utilisateur d'une photo n'est pas nul ; s'il est nul, il n'apparaîtra pas dans le résultat.
-- La jointure externe gauche/droite résout ce problème.
...
-- 6. A l'exercice précedent afficher aussi le nom de l'utilisateur qui a commenté ses propres photos
SELECT
url,
contents,
username
...
-- Trouver le nombre de commentaires pour chaque photo dont le photo_id est inférieur à 3 et la photo a plus de 2 commentaires
SELECT
photo_id,
